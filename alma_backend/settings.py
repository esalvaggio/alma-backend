"""
Django settings for alma_backend project.
...
ALLOWED_HOSTS = ['alma-backend-e8edf244cc30.herokuapp.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'alma_backend.wsgi.application'
